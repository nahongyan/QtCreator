...
/*!
 * 可以使用SettingsAccessor读取/写入XML格式的设置。
 */
...
/*!
从磁盘路径读取文件并将数据提取到一个RestoreData集。此方法不对文件内容进行任何处理。
 */
...
/*!
写一个文件在路径到磁盘和存储数据。此方法不对文件内容进行任何处理。
 */
optional<SettingsAccessor::Issue>
